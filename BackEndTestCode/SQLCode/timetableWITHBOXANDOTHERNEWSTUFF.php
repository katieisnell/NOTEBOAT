...
<div>
  ...
  <button id="overlaps" onclick="overlaps()">overlaps?</button>
</div>
<script>
...
classIndex=0;
  ...
  function placeClass(name, start, duration, className, weekNo, sem, colour, weekNo, location) {
    ...
    $("<div class='box' id='boxDialog'></div>").appendTo("#unmovableBox"+classIndex);
    $('#boxDialog').attr('id', classIndex+'Dialog');

    addDialogClass(name, start, duration, className, weekNo, sem, weekNo, location, classIndex);
  }
  ...
  function   addDialogClass(name, start, duration, className, weekNo, sem, weekNo, location, classIndex){
    $( "#"+classIndex+"Dialog" ).html("Name:"+ name +'<br>'+"Type:"+type+'<br>'+"Class Name:"+className
                                      +'<br>'+"Week Number:"+weekNo+'<br>'+"Semester:"+sem
                                      +'<br>'+"location"+location);
    $( "#"+classIndex+"Dialog" ).dialog({
                 autoOpen: false, 
                 buttons: {
                    'OK': function() {$(this).dialog("close");}
                 },
    ...
    $("#"+classIndex).dblclick(function(){  $( "#"+classIndex+"Dialog" ).dialog( "open" );});
  }
